...
namespace ArenaPlayerUtils
{
	...
	bool attemptPickPocket(ArenaCityType cityType, int thievingDivisor, int playerLevel, const PrimaryAttributes &attributes, ArenaRandom &random, int *outTemplateIndex, int *outGoldAmount, bool *outGuardsAppear);
